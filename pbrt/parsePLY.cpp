...
#define Z               2
      ...
      PlyProperty vert_props[] = { /* list of property information for a vertex */
        {(char*)"x", PLY_FLOAT, PLY_FLOAT, offsetof(::plib::pbrt::ply::Vertex,coord[X]), 0, 0, 0, 0},
        {(char*)"y", PLY_FLOAT, PLY_FLOAT, offsetof(::plib::pbrt::ply::Vertex,coord[Y]), 0, 0, 0, 0},
        {(char*)"z", PLY_FLOAT, PLY_FLOAT, offsetof(::plib::pbrt::ply::Vertex,coord[Z]), 0, 0, 0, 0},
        {(char*)"nx", PLY_FLOAT, PLY_FLOAT, offsetof(::plib::pbrt::ply::Vertex,normal[X]), 0, 0, 0, 0},
        {(char*)"ny", PLY_FLOAT, PLY_FLOAT, offsetof(::plib::pbrt::ply::Vertex,normal[Y]), 0, 0, 0, 0},
        {(char*)"nz", PLY_FLOAT, PLY_FLOAT, offsetof(::plib::pbrt::ply::Vertex,normal[Z]), 0, 0, 0, 0},
        {(char*)"diffuse_red", PLY_UCHAR, PLY_UCHAR, offsetof(::plib::pbrt::ply::Vertex,red), 0, 0, 0, 0},
        {(char*)"diffuse_green", PLY_UCHAR, PLY_UCHAR, offsetof(::plib::pbrt::ply::Vertex,green), 0, 0, 0, 0},
        {(char*)"diffuse_blue", PLY_UCHAR, PLY_UCHAR, offsetof(::plib::pbrt::ply::Vertex,blue), 0, 0, 0, 0},
      };
      enum {
        VTX_X = 0,
        VTX_Y,
